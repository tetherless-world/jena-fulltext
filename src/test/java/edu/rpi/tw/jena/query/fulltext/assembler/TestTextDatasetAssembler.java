    ...
    static {
        ...
        customTextDocProducerSpec =
            model.createResource(TESTBASE + "customTextDocProducerSpec")
                 ...
                 .addProperty(TextVocab.pTextDocProducer, model.createResource("java:edu.rpi.tw.jena.query.fulltext.assembler.TestTextDatasetAssembler$CustomTextDocProducer"));
        ...
        customDyadicTextDocProducerSpec =
            model.createResource(TESTBASE + "customDyadicTextDocProducerSpec")
                 ...
                 .addProperty(TextVocab.pDataset, SIMPLE_DATASET_SPEC)
                 .addProperty(TextVocab.pIndex, SIMPLE_INDEX_SPEC5)
                 .addProperty(TextVocab.pTextDocProducer, model.createResource("java:edu.rpi.tw.jena.query.fulltext.assembler.TestTextDatasetAssembler$CustomDyadicTextDocProducer"));
    }
